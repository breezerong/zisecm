...
public class CustomProcessDiagramGenerator extends DefaultProcessDiagramGenerator {
	...
	protected static CustomProcessDiagramCanvas initCustomProcessDiagramCanvas(BpmnModel bpmnModel, String imageType, String activityFontName,
		...
		return new CustomProcessDiagramCanvas((int) maxX + 10, (int) maxY + 10, (int) minX, (int) minY, imageType, activityFontName, labelFontName,
				annotationFontName, customClassLoader);
	}
