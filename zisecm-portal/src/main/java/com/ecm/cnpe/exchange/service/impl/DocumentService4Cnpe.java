...
public class DocumentService4Cnpe extends DocumentService{
	...
	public List<Map<String, Object>> getObjects4Cnpe(String token, String gridName, String folderId, Pager pager,
		...
		String sql="select "+ baseColumns + getGridColumn(gv, gridName) +" from (" + 
				"	select "+columns+",b.ID as TRSID,b.STAUTS as STAUTS,b.TO_NAME,b.COMMENT as C_REJECT_COMMENT,b.REJECTER as C_REJECTOR,b.REJECT_DATE as C_REJECT_DATE,b.APPLICANT as C_EX5_STRING,b.COMMENT1 AS C_EX6_STRING,b.STAUTS1 AS C_EX7_STRING,b.APPLY_DATE AS C_ITEM8_DATE from ecm_document a, exc_transfer b where a.id=b.doc_id" + 
