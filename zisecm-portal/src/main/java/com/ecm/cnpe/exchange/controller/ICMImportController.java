...
@Controller
public class ICMImportController extends ControllerAbstract{
	...
	@RequestMapping(value = "/ICMimport/getImportList/{id}", method = RequestMethod.GET)
	@ResponseBody
	...
	@RequestMapping(value = "/ICMimport/getImportTemplates", method = RequestMethod.GET)
	@ResponseBody
	public Map<String, Object> getImportTemplates() throws Exception {
		if(ICMImportController.imporFolderId==null) {
			ICMImportController.imporFolderId = folderService.getObjectByPath(getToken(), "/系统配置/导入模板/ICM").getId();
		}
		String sql = "select ID,NAME from ecm_document where FOLDER_ID='"+ICMImportController.imporFolderId+"' and TYPE_NAME='模板'  order by NAME";
	...
	@RequestMapping(value = "/ICMimport/getImportDocList/{id}", method = RequestMethod.GET)
	@ResponseBody
	...
	@RequestMapping(value = "/ICMimport/batchImport", method = RequestMethod.POST)
	@ResponseBody
	...
	@RequestMapping(value = "/ICMimport/importOnServer", method = RequestMethod.POST)
	@ResponseBody
