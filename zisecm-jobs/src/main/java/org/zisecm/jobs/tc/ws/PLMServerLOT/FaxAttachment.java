...
@XmlRootElement(name="FaxAttachment",namespace="http://PLMServerLOT.ws.cnpe.com/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name="FaxAttachment",namespace="http://PLMServerLOT.ws.cnpe.com/")
public class FaxAttachment implements java.io.Serializable{
		...
		public FaxAttachment() {
		}
		
		
		public FaxAttachment(String fileCode, String fileRevision,
