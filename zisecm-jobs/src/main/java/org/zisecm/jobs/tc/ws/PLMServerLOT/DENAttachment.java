...
@XmlRootElement(name="DENAttachment",namespace="http://PLMServerLOT.ws.cnpe.com/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name="DENAttachment",namespace="http://PLMServerLOT.ws.cnpe.com/")
public class DENAttachment  implements java.io.Serializable {
