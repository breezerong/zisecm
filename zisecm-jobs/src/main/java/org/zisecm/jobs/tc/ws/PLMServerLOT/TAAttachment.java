...
@XmlRootElement(name="TAAttachment",namespace="http://PLMServerLOT.ws.cnpe.com/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name="TAAttachment",namespace="http://PLMServerLOT.ws.cnpe.com/")

public class TAAttachment  implements java.io.Serializable {
