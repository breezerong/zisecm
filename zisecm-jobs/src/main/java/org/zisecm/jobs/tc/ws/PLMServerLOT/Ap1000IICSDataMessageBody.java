...
@XmlRootElement(name="Ap1000IICSDataMessageBody",namespace="http://PLMServerLOT.ws.cnpe.com/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name="Ap1000IICSDataMessageBody",namespace="http://PLMServerLOT.ws.cnpe.com/")
public class Ap1000IICSDataMessageBody  implements java.io.Serializable {
...
private String sendLotNo;
	...
	public Ap1000IICSDataMessageBody(String projectid, String revisionID,
			String sendTo, String sendFrom, String sendRecvLettDate,
			String pages, String ourDocNum, String preOrFin, String extCc,
			String intfcIdent, String oneParty, String twoParty,
			String releaseParty, String recvParty, String icmDate,
			String intfcDetailDescr, String intfcInfo, String intCC,
			String shenCConclu, String shenCSugg, String cpartDocNum,
	...
	public Ap1000IICSDataMessageBody() {
		super();
	}
