...
@XmlRootElement(name="FileAttachment",namespace="http://PLMServerLOT.ws.cnpe.com/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name="FileAttachment",namespace="http://PLMServerLOT.ws.cnpe.com/")
public class FileAttachment implements java.io.Serializable{
		...
		public FileAttachment(String fileCode, String fileRevision,
