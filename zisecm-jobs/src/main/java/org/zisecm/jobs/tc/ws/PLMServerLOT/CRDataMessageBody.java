...
@XmlRootElement(name="CRDataMessageBody",namespace="http://PLMServerLOT.ws.cnpe.com/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name="CRDataMessageBody",namespace="http://PLMServerLOT.ws.cnpe.com/")
public class CRDataMessageBody  implements java.io.Serializable {
   ...
   // private java.lang.String isReply;
    ...
    private org.zisecm.jobs.tc.ws.PLMServerLOT.CRFileList[] crList;

    private org.zisecm.jobs.tc.ws.PLMServerLOT.CRAttachment[] attachments;
	...
	public String getSendLotData() {
		return sendLotData;
	}



	public void setSendLotData(String sendLotData) {
		this.sendLotData = sendLotData;
	}



	public CRDataMessageBody(String projectid, String revision, String theme,
			...
			String isReply, String sendDate, CRFileList[] crList,
			CRAttachment[] attachments, String areaCode, String levelCode,
	...
	public CRDataMessageBody() {
    }

	

	public org.zisecm.jobs.tc.ws.PLMServerLOT.CRFileList[] getCrList() {
		return crList;
	}



	public void setCrList(org.zisecm.jobs.tc.ws.PLMServerLOT.CRFileList[] crList) {
		this.crList = crList;
	}



	public org.zisecm.jobs.tc.ws.PLMServerLOT.CRAttachment[] getAttachments() {
		return attachments;
	}



	public void setAttachments(org.zisecm.jobs.tc.ws.PLMServerLOT.CRAttachment[] attachments) {
		this.attachments = attachments;
	}
