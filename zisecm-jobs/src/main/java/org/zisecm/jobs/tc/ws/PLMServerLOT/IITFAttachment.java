...
@XmlRootElement(name="IITFAttachment",namespace="http://PLMServerLOT.ws.cnpe.com/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name="IITFAttachment",namespace="http://PLMServerLOT.ws.cnpe.com/")
public class IITFAttachment  implements java.io.Serializable {
