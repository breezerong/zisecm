...
@XmlRootElement(name="DesignReviewFList",namespace="http://PLMServerLOT.ws.cnpe.com/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name="DesignReviewFList",namespace="http://PLMServerLOT.ws.cnpe.com/")
public class DesignReviewFFileList  implements java.io.Serializable {
