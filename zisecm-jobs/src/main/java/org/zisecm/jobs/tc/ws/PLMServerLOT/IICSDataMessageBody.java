...
@XmlRootElement(name="IICSDataMessageBody",namespace="http://PLMServerLOT.ws.cnpe.com/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name="IICSDataMessageBody",namespace="http://PLMServerLOT.ws.cnpe.com/")
public class IICSDataMessageBody  implements java.io.Serializable {
    ...
    private String cpartDocNum;
    
    private String iITFSendDocDate;
    
    private String shenCConclu;
    
    private String shenCSugg;
    
    private String sendLotNo;
	
    
	public IICSDataMessageBody(String projectid, String revisionID,
			...
			String intfcDetailDescr, String intfcInfo, String cpartDocNum,
			String iITFSendDocDate, String shenCConclu, String shenCSugg,
			String sendLotNo, String sendLotDate, String ifSendCD,
			IITFAttachment[] attachments) {
		super();
		...
		this.cpartDocNum = cpartDocNum;
		this.iITFSendDocDate = iITFSendDocDate;
		this.shenCConclu = shenCConclu;
		this.shenCSugg = shenCSugg;
    ...
    public String getCpartDocNum() {
		return cpartDocNum;
	}
	public void setCpartDocNum(String cpartDocNum) {
		this.cpartDocNum = cpartDocNum;
	}
	public String getiITFSendDocDate() {
		return iITFSendDocDate;
	}
	public void setiITFSendDocDate(String iITFSendDocDate) {
		this.iITFSendDocDate = iITFSendDocDate;
	}
	public String getShenCConclu() {
		return shenCConclu;
	}
	public void setShenCConclu(String shenCConclu) {
		this.shenCConclu = shenCConclu;
	}
	public String getShenCSugg() {
		return shenCSugg;
	}
	public void setShenCSugg(String shenCSugg) {
		this.shenCSugg = shenCSugg;
	}
	//邮寄光盘
