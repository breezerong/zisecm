...
public class MemoDataMessageBody implements java.io.Serializable {
	...
	*/
	...
	public MemoDataMessageBody() {
	}


	public MemoDataMessageBody(String revision, String projectId, String name,
			...
			String sendRecvLettDate, String requireReplyDate,
