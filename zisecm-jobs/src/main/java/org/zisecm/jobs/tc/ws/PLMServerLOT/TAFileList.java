...
@XmlRootElement(name="TAFileList",namespace="http://PLMServerLOT.ws.cnpe.com/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name="TAFileList",namespace="http://PLMServerLOT.ws.cnpe.com/")
public class TAFileList  implements java.io.Serializable {
