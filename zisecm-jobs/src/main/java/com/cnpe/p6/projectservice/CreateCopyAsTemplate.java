...
/**
 * <p>CreateCopyAsTemplate complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="CreateCopyAsTemplate">
 *   &lt;complexContent>
 ...
 *         &lt;element name="CopyActualToPlannedValues" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/>
...
@XmlType(name = "CreateCopyAsTemplate", propOrder = {
    "objectId",
    "epsObjectId",
    "copyRisks",
...
public class CreateCopyAsTemplate {
    ...
    @XmlElement(name = "CopyActualToPlannedValues")
    protected Boolean copyActualToPlannedValues;
    ...
    /**
     * 获取copyActualToPlannedValues属性的值。
     * 
     * @return
     *     possible object is
     *     {@link Boolean }
     *     
     */
    public Boolean isCopyActualToPlannedValues() {
        return copyActualToPlannedValues;
    }

    /**
     * 设置copyActualToPlannedValues属性的值。
     * 
     * @param value
     *     allowed object is
     *     {@link Boolean }
     *     
     */
    public void setCopyActualToPlannedValues(Boolean value) {
        this.copyActualToPlannedValues = value;
    }
