...
export default {
  ...
  data() {
   ...
   created(){ 
    ...
    _self.loading = true;
    axios.get('/admin/getSelectValue')
  ...
  methods: {
    ...
    save(indata) {
      let _self = this;
      axios.post('/admin/updateSelectValue',JSON.stringify(indata))
      .then(function(response) {
        _self.$message("保存成功!");
      })
      .catch(function(error) {
    ...
    del(indata) {
      let _self = this;
      axios.post('/admin/deleteSelectValue',JSON.stringify(indata))
      .then(function(response) {
        _self.$message("删除成功!");
        _self.refreshData();
      })
    ...
    additem(indata) {
      let _self = this;
      axios.post('/admin/newSelectValue',JSON.stringify(indata))
      .then(function(response) {
    ...
    search() {
      ...
      _self.dataList = _self.dataListFull.filter(function(item){
          return item.label.match(_self.inputkey) 
