...
export default {
  ...
  methods: {
    ...
    save(indata) {
      let _self = this;
      axios.post('/admin/updateMenu',JSON.stringify(indata))
      .then(function(response) {
        _self.refreshData();
    ...
    del(indata) {
      let _self = this;
      axios.post('/admin/deleteMenu',JSON.stringify(indata))
      .then(function(response) {
        _self.$message("删除成功!");
        _self.refreshData();
      })
    ...
    additem(indata) {
      let _self = this;
      axios.post('/admin/newMenu',JSON.stringify(indata))
      .then(function(response) {
          _self.dialogVisible = false;
          _self.refreshData();
          _self.dialogVisible = false;
