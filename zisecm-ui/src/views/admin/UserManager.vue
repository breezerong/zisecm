  ...
  <div>
        <el-dialog :title="dialogtitle" :visible.sync="dialogVisible" width="60%">
          <el-form :model="form" label-position="right" label-width="100px">
            <el-row >
              <el-col :span="12" >
                <el-form-item label="用户名" :label-width="formLabelWidth" :rules="[{ required: true, message: '必填', trigger: 'blur'}]">
                  <el-input v-model="form.name" auto-complete="off" :disabled="isReadOnly"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="登录名" :label-width="formLabelWidth" :rules="[{ required: true, message: '必填', trigger: 'blur'}]">
                  <el-input v-model="form.loginName" auto-complete="off" :disabled="isReadOnly"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="密码" :label-width="formLabelWidth" :rules="[{ required: form.loginType==1, message: '必填', trigger: 'blur'}]">
                  <el-input type="password" v-model="form.password" auto-complete="off" :disabled="clientPermission<form.clientPermission"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12">
              ...
              <el-col :span="12">
                <el-form-item label="邮箱" :label-width="formLabelWidth">
                  <el-input v-model="form.email" auto-complete="off" :disabled="clientPermission<form.clientPermission"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="电话" :label-width="formLabelWidth">
                  <el-input v-model="form.phone" auto-complete="off" :disabled="clientPermission<form.clientPermission"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12" >
              ...
              <el-col :span="24">
                <el-form-item label="说明" :label-width="formLabelWidth">
                  <el-input v-model="form.description" auto-complete="off" :disabled="clientPermission<form.clientPermission"></el-input>
                </el-form-item>
              </el-col>
          ...
          <div slot="footer" class="dialog-footer" v-if="clientPermission>=form.clientPermission || !isReadOnly">
        ...
        <tr>
          ...
          <el-table
            ...
            <el-table-column label="操作" width="240">
              <template slot-scope="scope">
                <el-button type="primary" plain icon="el-icon-info" title="属性" @click="edititem(scope.row)"></el-button>
                <el-button type="primary" plain icon="el-icon-refresh" title="更新签名" @click="addimage(scope.row)"></el-button>
                <el-button type="danger" plain icon="el-icon-delete" title="删除" @click="delitem(scope.row)"></el-button>
              </template>
            </el-table-column>
          </el-table>
          <el-pagination
