  ...
  <div>
    ...
    <el-table
        ...
        <el-table-column label="操作"  width="240">
          <template slot-scope="scope" >
            <router-link :to="{path:'/SelectValueManager',query:{name:scope.row.name}}"><el-button :plain="true" type="info" size="small" icon="edit">查看</el-button></router-link>
            &nbsp;
...
export default {
  ...
  methods: {
    ...
    del(indata) {
      let _self = this;
      axios.post('/admin/deleteQuery',JSON.stringify(indata))
      .then(function(response) {
        _self.$message("删除成功!");
        _self.refreshData();
      })
    ...
    additem(indata) {
      let _self = this;
      axios.post('/admin/newQuery',JSON.stringify(indata))
      .then(function(response) {
