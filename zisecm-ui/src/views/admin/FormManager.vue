...
export default {
  ...
  methods: {
    ...
    saveitem(indata) {
      let _self = this;
      axios.post("/admin/updateForm",JSON.stringify(indata))
        .then(function(response) {
          _self.$message("保存成功!");
        })
        .catch(function(error) {
    ...
    delitem(indata) {
      let _self = this;
      axios.post("/admin/deleteForm",JSON.stringify(indata))
        .then(function(response) {
          _self.$message("删除成功!");
          _self.refreshData();
        })
    ...
    additem(indata) {
      let _self = this;
      axios.post("/admin/newForm",JSON.stringify(indata))
        .then(function(response) {
    ...
    copyitem(indata) {
      let _self = this;
      axios.post("/admin/copyForm",JSON.stringify(indata))
        .then(function(response) {
          _self.$message("复制成功!");
          _self.dialogVisible = false;
          _self.refreshData();
