    ...
    let _self = this
     _self.axios({
      headers: {
        ...
        method: "post",
        data: username,
        url: "/zisecm/user/getGroupByUserName"
  ...
  mounted() {
    ...
    _self
      .axios({
        ...
        method: "post",
        data: 0,
        url: "/zisecm/admin/getArchivesFolder"
      })
      .then(function(response) {
    ...
    loadGridData(indata) {
      ...
      _self
        .axios({
          ...
          method: "post",
          data: JSON.stringify(m),
          url: "/zisecm/dc/getExceptBoxDocuments"
        })
        .then(function(response) {
    ...
    loadAllGridData(indata){
      ...
      _self
        .axios({
          ...
          method: "post",
          data: JSON.stringify(m),
          url: "/zisecm/dc/getContainBoxDocuments"
        })
        .then(function(response) {
          _self.itemDataList = response.data.data;
          _self.itemDataListFull = response.data.data;
    ...
    obtainItem() {
      ...
      if (this.selectedItemList.length > 0){
        ...
        _self.axios({
          ...
          method: "post",
          data: JSON.stringify(obtainItemId),
          url: "/zisecm/dc/obtainDocuments"
        }).then(function(response){
    ...
    destroyItem() {
      ...
      if (this.selectedItemList.length > 0){
        ...
        _self.axios({
          ...
          method: "post",
          data: JSON.stringify(deletItemId),
          url: "/zisecm/dc/destroyDocuments"
        }).then(function(response){
          if(response.data.code){
            if(_self.showBox){
              _self.loadAllGridData(_self.currentFolder)
