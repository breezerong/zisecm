          ...
          <tr>
            <td class="navbar">
              <el-breadcrumb>
                ...
                <el-breadcrumb-item>档案接收</el-breadcrumb-item>
              </el-breadcrumb>
            </td>
          </tr>
          <tr>
            <td>
              <table border="0" width="100%" class="topbar">
                <tr>
                  <td align="left" width="73px">
                    <el-tooltip  class="item" effect="dark" content="回退"  placement="top">
                      <el-button type="primary" icon="el-icon-error" circle @click="onUpdateStatus('产生')"></el-button>
                    </el-tooltip>
                    <el-tooltip  class="item" effect="dark" content="接收" placement="top">
                      <el-button type="primary" icon="el-icon-success" circle @click="onUpdateStatus('整编')"></el-button>
                    </el-tooltip>
...
export default {
  ...
  methods: {
    ...
    getTypeNames(keyName){
      let _self=this;
      axios.post("/dc/getParameters",keyName)
      .then(function(response) {
