<template>
  <div>
    <el-dialog v-dialogDrag :title="$t('application.objectPermission9')" 
      :append-to-body="true"
      ...
      <div slot="footer" class="dialog-footer">
        <el-button type="primary" plain @click="saveItem(form)">{{$t('application.ok')}}</el-button>
        <el-button type="primary" plain @click="dialogVisible = false">{{$t('application.cancel')}}</el-button>
      </div>
    </el-dialog>
    <!-- <el-dialog v-dialogDrag title="删除权限" 
      :append-to-body="true"
      :close-on-click-modal="false"
      v-loading="loading"
      ...
      <div slot="footer" class="dialog-footer">
        <el-button type="primary" plain @click="onDelete()">{{$t('application.ok')}}</el-button>
        <el-button type="primary" plain @click="deleteDialogVisible = false">{{$t('application.cancel')}}</el-button>
      </div>
    </el-dialog> -->
    <el-row>
      <el-col :span="6">
      ...
      <el-col :span="2" style="padding-left:10px;text-align:left;">
        <el-button type="primary" plain v-if="systemPermission>=9 || permission>=9" size="small" icon="el-icon-edit" @click="newItem()">{{$t('application.new')}}</el-button>
      </el-col>
    </el-row>
    <el-row>
      <el-col>
