...
// });
import FormItemSelector from '@/components/controls/FormItemSelector'
  ...
  created() {
    ...
    _self
      .axios({
        ...
        method: "post",
        data: _self.parentid,
        url: "/zisecm/admin/getCardSearchItem"
      })
    ...
    saveitem(indata) {
      ...
      _self
        .axios({
          ...
          url: "/zisecm/admin/updateCardSearchItem"
        })
        .then(function(response) {
          _self.$message("保存成功!");
        })
    ...
    delitem(indata) {
      ...
      _self
        .axios({
          ...
          method: "post",
          data: JSON.stringify(indata),
          url: "/zisecm/admin/deleteCardSearchItem"
        })
        .then(function(response) {
          _self.$message("删除成功!");
          _self.refreshData();
    ...
    additem(indata) {
      ...
      _self
        .axios({
          ...
          method: "post",
          data: JSON.stringify(indata),
          url: "/zisecm/admin/newCardSearchItem"
        })
        .then(function(response) {
