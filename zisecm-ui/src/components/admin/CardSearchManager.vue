  ...
  created() {
    ...
    _self
      .axios({
        ...
        method: "get",
        url: "/zisecm/admin/getCardSearch"
      })
    ...
    saveitem(indata) {
      ...
      _self
        .axios({
          ...
          url: "/zisecm/admin/updateCardSearch"
        })
        .then(function(response) {
          _self.$message("保存成功!");
        })
    ...
    delitem(indata) {
      ...
      _self
        .axios({
          ...
          method: "post",
          data: JSON.stringify(indata),
          url: "/zisecm/admin/deleteCardSearch"
        })
        .then(function(response) {
          _self.$message("删除成功!");
          _self.refreshData();
    ...
    additem(indata) {
      ...
      _self
        .axios({
          ...
          method: "post",
          data: JSON.stringify(indata),
          url: "/zisecm/admin/newCardSearch"
        })
        .then(function(response) {
    ...
    copyitem(indata) {
      ...
      _self
        .axios({
          ...
          method: "post",
          data: JSON.stringify(indata),
          url: "/zisecm/admin/copyCardSearch"
        })
        .then(function(response) {
          _self.$message("复制成功!");
          _self.dialogVisible = false;
