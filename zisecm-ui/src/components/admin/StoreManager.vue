  ...
  <div>
    ...
    <el-table
        ...
        <el-table-column label="操作"  width="320">
          <template slot-scope="scope">
            <el-button :plain="true" type="success" size="small" icon="save" @click="saveitem(scope.row)">保存</el-button>
