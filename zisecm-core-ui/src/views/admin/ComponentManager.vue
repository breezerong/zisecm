...
export default {
  ...
  methods: {
    ...
    save(indata) {
      let _self = this;
      axios.post('/admin/updateComponent',JSON.stringify(indata))
      .then(function(response) {
        _self.$message("保存成功!");
      })
      .catch(function(error) {
    ...
    del(indata) {
      let _self = this;
      axios.post('/admin/deleteComponent',JSON.stringify(indata))
      .then(function(response) {
        _self.$message("删除成功!");
        _self.refreshData();
      })
    ...
    additem(indata) {
      let _self = this;
      axios.post('/admin/newComponent',JSON.stringify(indata))
      .then(function(response) {
