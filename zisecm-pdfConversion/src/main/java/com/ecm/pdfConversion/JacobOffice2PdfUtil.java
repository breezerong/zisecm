...
public class JacobOffice2PdfUtil {
	 ...
	 * @return
	 */
	public boolean office2pdf(String inputFileName, String pdf_path) {
...
//		String pdfUserPath = String.format(pdf_path + "/%s/%s", username, inputFileName + ".pdf");
		...
		int time = convert2PDF(inputFileName, pdf_path);
...
// 调用Documents对象中Open方法打开文档，并返回打开的文档对象Document
			...
			/***
			 *   调用Document对象的SaveAs方法，将文档保存为pdf格式   Dispatch.call(doc, "SaveAs", pdfFile,
